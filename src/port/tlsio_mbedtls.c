...
static void on_underlying_io_bytes_received(void *context, const unsigned char *buffer, size_t size)
{
    if (context != NULL)
    {
        ...
        else
        {
            ...
            printf("on_underlying_io_bytes_received count:%d\n" , tls_io_instance->socket_io_read_byte_count );
...
//debug
            ...
            mbedtls_ssl_conf_dbg(&tls_io_instance->config, my_debug, stdout);
...
int tlsio_mbedtls_setoption(CONCRETE_IO_HANDLE tls_io, const char *optionName, const void *value)
{
    ...
    if (0 != atca_mbedtls_pk_init(&tls_io_instance->pKey, 0))
    {
    ...
    if (0 != atca_mbedtls_cert_add(&tls_io_instance->owncert, &g_cert_def_2_device))
    {
    ...
    if (0 != atca_mbedtls_cert_add(&tls_io_instance->owncert, &g_cert_def_1_signer))
    {
        printf("Failed to parse cert from device\n");
    ...
    if(0 != (ret = mbedtls_ssl_conf_own_cert(
            &tls_io_instance->config, &tls_io_instance->owncert, &tls_io_instance->pKey)))
    {
